    ...
    <section id="why" className="section relative overflow-hidden bg-surface-muted">
      ...
      <Container className="relative">
        <SectionHeading
          ...
          title={
            <>
              Reasons the region is coming to{' '}
              <span className="text-gradient">trust us</span>
            </>
          }
          lead="We pair pharmaceutical rigour with a genuine care for the people who take our products — and it shows in everything we make."
          align="center"
