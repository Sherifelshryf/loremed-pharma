      ...
      <Container>
        <div className="relative overflow-hidden rounded-[2.75rem] bg-primary-900 px-6 py-16 shadow-glow sm:px-12 sm:py-20 lg:px-20">
          ...
          <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
            ...
            <div className="absolute -right-16 -top-16 h-96 w-96 rounded-full bg-secondary-500/25" />
            <div className="absolute -left-20 bottom-0 h-80 w-80 rounded-full bg-primary-600/40" />
