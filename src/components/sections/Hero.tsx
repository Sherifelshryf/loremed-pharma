      ...
      <Container className="relative">
        <div className="grid items-center gap-14 pb-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10 lg:pb-24">
          ...
          <div className="max-w-xl">
            <div >
              <span className="inline-flex items-center gap-2 rounded-full border border-line bg-white px-4 py-1.5 shadow-soft">
          ...
          >
            ...
            <div
              aria-hidden
              className="absolute inset-6 rounded-[3rem] bg-gradient-to-br from-primary-100/60 to-secondary-100/50"
            />
            {/* Panel */}
            <div className="absolute inset-0 grid place-items-center rounded-[2.75rem] border border-white/70 bg-white/50 shadow-glow">
...
function FloatingCard({
  ...
  return (
    ...
    >
      <div
        className="flex items-center gap-3 rounded-2xl border border-line bg-white px-4 py-3 shadow-card"
      >
