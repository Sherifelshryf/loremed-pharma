...
export const products: Product[] = [
  {
    ...
    tagline: { en: 'Ivy & more', ar: 'لبلاب وأكتر' },
    category: 'respiratory-care',
    status: 'available',
    form: { en: 'Syrup', ar: 'شراب' },
    ageGroup: { en: 'Adults & children 2+', ar: 'الكبار والأطفال من سنتين فوق' },
    pack: { en: '100 ml bottle with dosing cup', ar: 'زجاجة 100 مل ومعاها كوباية قياس' },
    accent: 'purple',
    featured: true,
    ...
    shortDescription: {
      ...
      ar: 'شراب بمستخلصات طبيعية بيجمع ورق اللبلاب والبلسان الأسود وعسل النحل مع فيتامين ج والزنك عشان يخفف الكحة.',
    },
    description: {
      ...
      ar: 'إيفيلور بيدعم صحة الجهاز التنفسي بمزيج من المستخلصات الطبيعية: مستخلص ورق اللبلاب (38 مجم لكل 5 مل) اللي بيوسّع الشعب الهوائية ويذوّب البلغم ويهدّي التقلصات، والبلسان الأسود (25 مجم لكل 5 مل)، وعسل النحل (6 جم لكل 5 مل)، ومدعّمين بفيتامين ج والزنك. المكونات دي مع بعضها بتساعد على تخفيف الكحة وعلى تنظيف المجرى التنفسي من البلغم بشكل طبيعي، والمستخلصات المضادة للأكسدة والمنشّطة للمناعة بتدعم الجسم في موسم البرد والكحة.',
    },
    keyIngredients: [
      {
        name: { en: 'Ivy Leaves Extract', ar: 'مستخلص ورق اللبلاب' },
        note: {
          en: '38 mg per 5 ml — bronchodilator, mucolytic, antispasmodic, antioxidant & anti-inflammatory',
          ar: '38 مجم لكل 5 مل — بيوسّع الشعب الهوائية، بيذوّب البلغم، بيهدّي التقلصات، ومضاد للأكسدة والالتهاب',
        },
      },
      {
        ...
        note: {
          ...
          ar: '25 مجم لكل 5 مل — مضاد للأكسدة والالتهاب، وبينشّط المناعة',
        },
      },
      {
        ...
        note: {
          ...
          ar: '6 جم لكل 5 مل — مضاد للبكتيريا والأكسدة، بينشّط المناعة وبيلطّف الزور',
        },
      },
      {
        ...
        note: {
          ...
          ar: 'مضاد للأكسدة؛ الاتنين بيدعموا الجهاز المناعي',
        },
      },
    ],
    benefits: [
      { en: 'Indicated for cough, asthma and bronchitis', ar: 'بيُستخدم مع الكحة والربو والتهاب الشعب الهوائية' },
      { en: 'Supports relief of common cold and flu', ar: 'بيساعد على تخفيف نزلات البرد والإنفلونزا' },
      { en: 'Immunostimulant support', ar: 'بينشّط المناعة' },
      { en: 'Supports the airways in COPD', ar: 'بيدعم المجرى التنفسي في حالات الانسداد الرئوي المزمن' },
    ],
    usage: { en: '5 ml three times daily.', ar: '5 مل 3 مرات في اليوم.' },
  ...
  },
  {
    ...
    tagline: { en: 'Relief cough naturally', ar: 'راحة من الكحة بشكل طبيعي' },
    category: 'respiratory-care',
    status: 'available',
    form: { en: 'Syrup (orange flavour)', ar: 'شراب (بنكهة البرتقال)' },
    ageGroup: { en: 'Infants, children & adults', ar: 'الرُضّع والأطفال والكبار' },
    ...
    shortDescription: {
      ...
      ar: 'شراب للكحة من ورق اللبلاب والزعتر وعرق السوس — بنكهة البرتقال — للأطفال والكبار، وبيدعم صحة الجهاز التنفسي.',
    },
    description: {
      ...
      ar: 'إيفيلور أدفانس بيكمّل على تركيبة إيفيلور بمزيج من تلات نباتات في كل 5 مل: مستخلص ورق اللبلاب (35 مجم) اللي بيطرد البلغم، ومستخلص ورق الزعتر (21.5 مجم) بتأثيره المطهّر والمضاد للميكروبات، وجذر عرق السوس (21.7 مجم) اللي بيشتغل فيه مركّب الليكويريتين أبيوسيد كمهدّي للكحة وطارد للبلغم، مع نشاط مضاد للالتهاب والفيروسات. التلاتة مع بعض بيساعدوا على التخلص من البلغم في المجرى التنفسي وتهدئة التهاب الكحة. الشراب بنكهة البرتقال — نكهة بس ومفيهوش برتقال — ومناسب للرُضّع والأطفال والكبار.',
    },
    keyIngredients: [
      {
        name: { en: 'Ivy Leaf Extract', ar: 'مستخلص ورق اللبلاب' },
        note: {
          en: '35 mg per 5 ml — expectorant; helps clear mucus from the airways',
          ar: '35 مجم لكل 5 مل — بيطرد البلغم وبيساعد على تنظيف المجرى التنفسي',
        },
      },
      {
        name: { en: 'Thyme Leaf Extract', ar: 'مستخلص ورق الزعتر' },
        note: {
          en: '21.5 mg per 5 ml — antiseptic & antimicrobial; helps reduce cough inflammation',
          ar: '21.5 مجم لكل 5 مل — مطهّر ومضاد للميكروبات؛ بيساعد على تقليل التهاب الكحة',
        },
      },
      {
        ...
        note: {
          ...
          ar: '21.7 مجم لكل 5 مل — ليكويريتين أبيوسيد؛ بيهدّي الكحة، بيطرد البلغم، ومضاد للالتهاب والفيروسات',
        },
      },
    ],
    benefits: [
      { en: 'Indicated for cough and for acute and chronic bronchitis', ar: 'بيُستخدم مع الكحة والتهاب الشعب الهوائية الحاد والمزمن' },
      { en: 'Expectorant action helps clear mucus from the airways', ar: 'بيطرد البلغم ويساعد على تنظيف المجرى التنفسي' },
      { en: 'Helps reduce cough inflammation', ar: 'بيساعد على تقليل التهاب الكحة' },
      { en: 'Suitable for infants, children and adults', ar: 'مناسب للرُضّع والأطفال والكبار' },
    ],
    usage: {
      ...
      ar: 'الرُضّع: 2.5 مل (نص ملعقة صغيرة) 3 مرات في اليوم. الأطفال: 5 مل (ملعقة صغيرة) 3 مرات في اليوم. الكبار: 10 مل (ملعقتين صغيرين) 3 مرات في اليوم.',
    },
  ...
  },
  {
    ...
    pack: { en: 'Bottle with dosing cup', ar: 'زجاجة ومعاها كوباية قياس' },
    accent: 'purple',
    ...
    shortDescription: {
      ...
      ar: 'شراب للأطفال بتركيز عالي من أوميغا-3 المستخلص من زيت السمك (إي بي إيه ودي إتش إيه) ومستخلص زهرة الآذريون عشان يدعم التعلّم والنمو.',
    },
    description: {
      ...
      ar: 'كوجليرن شراب متعمل مخصوص للأطفال في سن النمو والتعلّم — بيجمع أوميغا-3 عالي التركيز (إي بي إيه ودي إتش إيه) المستخلص من زيت السمك مع مستخلص زهرة الآذريون (اللوتين) في شراب طعمه حلو وسهل التناول. اتعمل عشان يدعم نمو المخ ووظائفه والتركيز والنمو الصحي في سنين الدراسة.',
    },
    keyIngredients: [
      {
      ...
      },
      {
        ...
        note: {
          ...
          ar: '448.9 مجم لكل 5 مل — بيدعم وظائف المخ الطبيعية',
        },
      },
      {
    ...
    benefits: [
      { en: 'Supports brain growth, function and concentration', ar: 'بيدعم نمو المخ ووظائفه والتركيز' },
      { en: 'High-strength omega-3 in a child-friendly syrup', ar: 'أوميغا-3 عالي التركيز في شراب طعمه بيعجب الأطفال' },
      { en: 'Lutein from marigold supports eye health', ar: 'اللوتين اللي في الآذريون بيدعم صحة العين' },
      { en: 'Omega-3s may support healthy bone and reduce allergy and insulin-resistance risk', ar: 'أوميغا-3 ممكن يدعم صحة العظام ويقلل خطر الحساسية ومقاومة الإنسولين' },
    ],
    usage: {
      ...
      ar: 'الأطفال من 13 شهر لحد أقل من 6 سنين: نص ملعقة صغيرة مرتين في اليوم. الأطفال من 6 لحد أقل من 12 سنة: ملعقة صغيرة مرتين في اليوم. الكبار والمراهقين فوق 12 سنة: ملعقة صغيرة 3 مرات في اليوم.',
    },
  ...
  },
  {
    ...
    ageGroup: { en: 'Infants & neonates', ar: 'الرُضّع وحديثي الولادة' },
    ...
    shortDescription: {
      ...
      ar: 'نقط فيها دي إتش إيه من زيت السمك وفيتامين هـ وفيتامين د لصحة المخ من بدري وللمناعة والنمو السليم.',
    },
    description: {
      ...
      ar: 'سمارتود بيجمع دي إتش إيه المستخلص من زيت السمك مع فيتامين هـ وفيتامين د في نقط سايلة سهل تحديد جرعتها. متعمل لأول مراحل العمر، وبيدعم صحة المخ والمزاج، ونمو العظام والسنان بشكل سليم، والوظيفة الطبيعية للجهاز المناعي.',
    },
    keyIngredients: [
      {
        name: { en: 'Omega-3 DHA (from fish oil)', ar: 'أوميغا-3 دي إتش إيه (من زيت السمك)' },
        note: {
          ...
          ar: 'بيعزز صحة المخ والمزاج، وبيساعد على نوم أحسن',
        },
      },
      {
        ...
        note: {
          ...
          ar: 'بيدعم نمو العظام والسنان والمناعة',
        },
      },
      {
        ...
        note: {
          ...
          ar: 'مضاد للأكسدة بيدعم المناعة وإصلاح الحمض النووي',
        },
      },
    ],
    benefits: [
      { en: 'Immunostimulant support for infants', ar: 'بينشّط مناعة الرُضّع' },
      { en: 'Supports healthy growth in cases of malnutrition', ar: 'بيدعم النمو الصحي في حالات سوء التغذية' },
      { en: 'Supportive care for neonatal anemia', ar: 'بيساعد في حالات أنيميا حديثي الولادة' },
      { en: 'DHA promotes brain health, mood and better sleep', ar: 'دي إتش إيه بيعزز صحة المخ والمزاج والنوم' },
    ],
    usage: { en: '0.5 ml twice daily.', ar: '0.5 مل مرتين في اليوم.' },
  ...
  },
  {
    ...
    status: 'available',
    form: { en: 'Oral drops', ar: 'نقط بالفم' },
    ageGroup: { en: '6 months & above', ar: 'من 6 شهور فوق' },
    ...
    shortDescription: {
      ...
      ar: 'نقط فيتامين د3 بتدعم صحة العظام والمناعة من عمر 6 شهور.',
    },
    description: {
      ...
      ar: 'سمارتود د بيقدّم فيتامين د3 (كوليكالسيفيرول) في نقطة واحدة كل يوم. فيتامين د بيدعم امتصاص الكالسيوم بشكل طبيعي، ونمو عظام وسنان صحية، والوظيفة الطبيعية للجهاز المناعي — وده مهم بشكل خاص لما يكون التعرض للشمس قليل.',
    },
    keyIngredients: [
      {
        name: { en: 'Vitamin D3 (Cholecalciferol)', ar: 'فيتامين د3 (كوليكالسيفيرول)' },
        note: { en: 'Supports bone and immune health', ar: 'بيدعم صحة العظام والمناعة' },
      },
    ],
    benefits: [
      { en: 'Supports normal calcium absorption', ar: 'بيدعم امتصاص الكالسيوم بشكل طبيعي' },
      { en: 'Supports healthy bones and teeth', ar: 'بيدعم صحة العظام والسنان' },
      { en: 'Supports normal immune function', ar: 'بيدعم الوظيفة الطبيعية للمناعة' },
      { en: 'Simple once-daily drop', ar: 'نقطة واحدة بس كل يوم' },
    ],
    usage: { en: 'One drop daily, or as directed by your doctor.', ar: 'نقطة واحدة كل يوم، أو حسب إرشادات الدكتور.' },
    related: ['smartod', 'imulormed', 'ivylor'],
  },
  {
    slug: 'vitelormed',
    ...
    status: 'available',
    form: { en: 'Syrup', ar: 'شراب' },
    ageGroup: { en: 'Children 3+ & adults', ar: 'الأطفال من 3 سنين فوق والكبار' },
    ...
    shortDescription: {
      ...
      ar: 'شراب فيه 12 فيتامين و5 معادن مع إل-ليسين، بيحسّن الشهية والمناعة وبيدعم أقصى نمو وتطور.',
    },
    description: {
      ...
      ar: 'فيتيلورميد بيجمع 12 فيتامين و5 معادن مع الحمض الأميني الأساسي إل-ليسين في شراب واحد كل يوم، متعمل لأقصى نمو وتطور. مجموعة فيتامينات ب الكاملة (ب1، ب2، ب3، ب5، ب6، ب7، ب9 وب12) بتدعم استقلاب الطاقة، وفيتامينات أ وج ود3 وهـ بتزوّد الدعم المضاد للأكسدة ودعم المناعة والعظام، والزنك والحديد والمغنيسيوم والكالسيوم واليود بيغطوا المعادن الأساسية. كل ده مع بعضه بيساعد على تحسين الشهية والمناعة، وبيدعم علاج سوء التغذية، وبيحافظ على النشاط الذهني والبدني.',
    },
    keyIngredients: [
      {
        ...
        note: {
          ...
          ar: 'حمض أميني أساسي — بيدعم الشهية والنمو والتطور',
        },
      },
      {
        ...
        note: {
          ...
          ar: 'ب1، ب2، ب3 (نياسين)، ب5، ب6، ب7 (بيوتين)، ب9 (حمض الفوليك) وب12 — بتدعم استقلاب الطاقة',
        },
      },
      {
    ...
    benefits: [
      { en: 'Helps improve appetite', ar: 'بيساعد على تحسين الشهية' },
      { en: 'Supports immunity', ar: 'بيدعم المناعة' },
      { en: 'Supports the management of malnutrition', ar: 'بيدعم علاج سوء التغذية' },
      { en: 'Supports mental and physical activity', ar: 'بيدعم النشاط الذهني والبدني' },
    ],
    usage: {
      ...
      ar: 'الأطفال 3–6 سنين: 2.5 مل كل يوم. الأطفال 7–12 سنة: 5 مل كل يوم. الأطفال فوق 12 سنة والكبار: 10 مل كل يوم. الأطفال أقل من 3 سنين، مايتاخدش غير بعد استشارة الدكتور.',
    },
  ...
  },
  {
    ...
    tagline: { en: 'A step to easier days', ar: 'خطوة لأيام أسهل' },
    category: 'kids-health',
    status: 'available',
    form: { en: 'Syrup', ar: 'شراب' },
    ageGroup: { en: 'Infants & children', ar: 'الرُضّع والأطفال' },
    pack: { en: '100 ml bottle', ar: 'زجاجة 100 مل' },
    accent: 'orange',
    ...
    shortDescription: {
      ...
      ar: 'شراب إنزيم هضمي ألفا-أميليز بيهدّي التهاب الزور ويسهّل الهضم ويساعد الجسم يقاوم التهابات الجهاز التنفسي.',
    },
    description: {
      ...
      ar: 'جوتولور شراب إنزيم هضمي للأطفال أساسه ألفا-أميليز (200 وحدة لكل مل). تأثيره المضاد للالتهاب بيساعد على تخفيف التهاب الزور وتقليل التورم — خصوصًا بعد الجراحة أو الإصابة — والإنزيم بيساعد على تكسير النشويات عشان هضم الكربوهيدرات يبقى أسهل. وكمان بيساعد على تقوية الجهاز المناعي للوقاية من التهابات الجهاز التنفسي العلوي وتخفيفها. مكمل غذائي لطيف وطعمه حلو، لأيام أسهل.',
    },
    keyIngredients: [
      {
    ...
    benefits: [
      { en: 'Helps relieve sore throat and reduce inflammation', ar: 'بيساعد على تخفيف التهاب الزور وتقليل الالتهاب' },
      { en: 'Eases swelling — beneficial post-surgery or injury', ar: 'بيخفف التورم — مفيد بعد الجراحة أو الإصابة' },
      { en: 'Supports carbohydrate digestion and relieves indigestion', ar: 'بيدعم هضم الكربوهيدرات وبيخفف عسر الهضم' },
      { en: 'Boosts immunity against upper respiratory tract infections', ar: 'بيقوّي المناعة ضد التهابات الجهاز التنفسي العلوي' },
    ],
    usage: {
      ...
      ar: 'الرُضّع والأطفال لحد 3 سنين (15 كجم): 5 مل (ملعقة صغيرة، 1000 وحدة) 3 مرات في اليوم. الأطفال فوق 3 سنين (أكتر من 15 كجم): 10 مل (ملعقة كبيرة، 2000 وحدة) 3 مرات في اليوم.',
    },
  ...
  },
  {
    ...
    ageGroup: { en: 'All ages', ar: 'كل الأعمار' },
    ...
    shortDescription: {
      ...
      ar: 'لوشن بيلطّف البشرة، وفيه كالامين وزيت بابونج وزيت زيتون، للاستعمال الخارجي.',
    },
    description: {
      ...
      ar: 'ويلكاديرم لوشن بيلطّف البشرة وأساسه تلات مكونات معروفة: الكالامين اللي بيستخدم من زمان لتهدئة البشرة المتهيّجة وحمايتها، وزيت البابونج المهدّي، وزيت الزيتون اللي بينعّم البشرة ويساعدها تحتفظ برطوبتها. منتج تجميلي للاستعمال الخارجي بس، في زجاجة 120 مل.',
    },
    ...
    keyIngredients: [
      {
        ...
        note: {
          ...
          ar: 'بيستخدم من زمان لتهدئة البشرة المتهيّجة وحمايتها',
        },
      },
      {
        name: { en: 'Chamomile Oil', ar: 'زيت البابونج' },
        note: { en: 'Soothing botanical oil', ar: 'زيت نباتي بيهدّي البشرة' },
      },
      {
        name: { en: 'Olive Oil', ar: 'زيت الزيتون' },
        note: {
          en: 'Emollient — softens skin and helps it hold moisture',
          ar: 'مُلطّف — بينعّم البشرة ويساعدها تحتفظ برطوبتها',
        },
      },
    ],
    benefits: [
      { en: 'Calamine helps calm and soothe the skin', ar: 'الكالامين بيساعد على تهدئة البشرة' },
      {
        en: 'Chamomile and olive oil soften and comfort dry skin',
        ar: 'البابونج وزيت الزيتون بينعّموا البشرة الجافة وبيريّحوها',
      },
      { en: 'Suitable for all ages', ar: 'مناسب لكل الأعمار' },
      { en: 'Cosmetic product — for external use only', ar: 'منتج تجميلي — للاستعمال الخارجي بس' },
    ],
    usage: {
      en: 'Apply a thin layer to clean, dry skin as often as needed. For external use only.',
      ar: 'يتحط طبقة رقيقة على بشرة نظيفة وجافة على حسب الحاجة. للاستعمال الخارجي بس.',
    },
  ...
  },
  {
    ...
    form: { en: 'Oral drops', ar: 'نقط بالفم' },
    ageGroup: { en: 'Infants & children 3 months – 5 years', ar: 'الرُضّع والأطفال من 3 شهور لـ5 سنين' },
    pack: { en: 'Dropper bottle with measuring guide', ar: 'زجاجة بقطارة ومعاها دليل للقياس' },
    accent: 'orange',
    ...
    shortDescription: {
      ...
      ar: 'تركيبة نباتية لدعم المناعة بتجمع مستخلص البلسان مع فيتامين ج والزنك وحمض الفوليك وفيتامين ب12.',
    },
    description: {
      ...
      ar: 'إميولورميد بيجمع مستخلص البلسان — واحد من أكتر النباتات الموثوقة في دعم المناعة — مدعّم بفيتامين ج والزنك وحمض الفوليك وفيتامين ب12. التركيبة متعملة عشان تدعم دفاعات الجسم الطبيعية من سن الرضاعة، وهي روتين يومي لطيف وسهل تضيفه على العصير أو المية.',
    },
    keyIngredients: [
      {
      ...
      },
      {
        ...
        note: { en: 'Contributes to normal immune function', ar: 'بيساهم في الوظيفة الطبيعية للمناعة' },
      },
      {
        name: { en: 'Zinc', ar: 'الزنك' },
        note: { en: 'Supports the immune system', ar: 'بيدعم الجهاز المناعي' },
      },
      {
        name: { en: 'Folic Acid', ar: 'حمض الفوليك' },
        note: { en: 'Supports normal development', ar: 'بيدعم النمو الطبيعي' },
      },
      {
        name: { en: 'Vitamin B12', ar: 'فيتامين ب12' },
        note: { en: 'Supports normal immune function', ar: 'بيدعم الوظيفة الطبيعية للمناعة' },
      },
    ],
    benefits: [
      { en: 'Supports the normal function of the immune system', ar: 'بيدعم الوظيفة الطبيعية للجهاز المناعي' },
      { en: 'Antioxidant protection from elderberry extract', ar: 'حماية مضادة للأكسدة من مستخلص البلسان' },
      { en: 'Simple dosing — added to juice or water', ar: 'جرعة بسيطة — تتضاف على العصير أو المية' },
      { en: 'Suitable from 3 months of age', ar: 'مناسب من عمر 3 شهور' },
    ],
    usage: {
      en: 'Infants & children 3 months – 1 year: 1 ml once daily, added to juice or water. Children 1–5 years: 1 ml twice daily.',
      ar: 'الرُضّع والأطفال من 3 شهور لسنة: 1 مل مرة واحدة في اليوم، تتضاف على العصير أو المية. الأطفال من 1 لـ5 سنين: 1 مل مرتين في اليوم.',
    },
  ...
  },
  {
    ...
    status: 'under-registration',
    form: { en: 'Syrup', ar: 'شراب' },
    ageGroup: { en: 'Children & adults', ar: 'الأطفال والكبار' },
    pack: { en: 'Bottle with dosing cup', ar: 'زجاجة ومعاها كوباية قياس' },
    accent: 'purple',
    ...
    shortDescription: {
      ...
      ar: 'تركيبة حديد لطيفة مع الفولات وفيتامين ج، بتدعم تكوين كرات الدم الحمرا وبتقلل الإرهاق.',
    },
    description: {
      ...
      ar: 'فيرولورميد بيجمع بيسجليسينات الحديد — وهو شكل من الحديد اتختار عشان يبقى لطيف على المعدة — مع الفولات وفيتامين ج اللي بيزوّد امتصاص الحديد. متعمل عشان يدعم التكوين الطبيعي لكرات الدم الحمرا وبيساعد على تقليل التعب والإرهاق من غير الآثار المزعجة اللي بتيجي عادة مع مكملات الحديد.',
    },
    keyIngredients: [
      {
        name: { en: 'Iron (Ferrous Bisglycinate)', ar: 'الحديد (بيسجليسينات الحديد)' },
        note: { en: 'Supports red blood cell formation', ar: 'بيدعم تكوين كرات الدم الحمرا' },
      },
      {
        name: { en: 'Folate (Folic Acid)', ar: 'الفولات (حمض الفوليك)' },
        note: { en: 'Supports normal blood formation', ar: 'بيدعم تكوين الدم الطبيعي' },
      },
      {
        name: { en: 'Vitamin C (L-Ascorbic Acid)', ar: 'فيتامين ج (حمض الأسكوربيك)' },
        note: { en: 'Enhances iron absorption', ar: 'بيزوّد امتصاص الحديد' },
      },
    ],
    benefits: [
      { en: 'Supports normal red blood cell formation', ar: 'بيدعم التكوين الطبيعي لكرات الدم الحمرا' },
      { en: 'Helps reduce tiredness and fatigue', ar: 'بيساعد على تقليل التعب والإرهاق' },
      { en: 'Gentle on the stomach', ar: 'لطيف على المعدة' },
      { en: 'Vitamin C enhances absorption', ar: 'فيتامين ج بيزوّد الامتصاص' },
    ],
    usage: { en: 'As directed by your doctor or pharmacist.', ar: 'حسب إرشادات الدكتور أو الصيدلي.' },
