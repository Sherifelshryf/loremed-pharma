...
export const dictionaries = {
  ...
  ar: {
    ...
    'order.errorPhoneInvalid': 'يرجى إدخال رقم هاتف محمول مصري صحيح.',
    'order.errorAddress': 'يرجى إدخال عنوان التوصيل.',
    'order.continueShopping': 'مواصلة التسوق',
    'order.newOrder': 'طلب جديد',
    'order.confirmSent': 'لقد أرسلت الطلب على واتساب',
    'order.confirmSentDone': 'شكرًا — تم إفراغ السلة.',
    ...
    'wholesale.businessType': 'أنت',
    'wholesale.name': 'اسم الصيدلية / الشركة',
    'wholesale.address': 'العنوان',
    'wholesale.notesPlaceholder': 'الكميات، المنتجات المطلوبة، أو أي تفاصيل أخرى؟',
    'wholesale.submit': 'أرسل الطلب عبر واتساب',
    'wholesale.submitHint':
      'سيفتح واتساب وطلبك جاهز — اضغط «إرسال» هناك ليصل إلى فريق المبيعات.',
    'wholesale.followUpNote': 'سيتواصل معك فريق المبيعات على هذا الرقم:',
    'wholesale.errorName': 'يُرجى إدخال اسم الصيدلية أو الشركة.',
    'wholesale.errorAddress': 'يُرجى إدخال العنوان.',
    'wholesale.successTitle': 'تم إرسال الطلب',
    'wholesale.successBody': 'تم تحويلك إلى واتساب وطلبك جاهز — يُرجى الضغط على «إرسال» هناك، وسيتولى فريق المبيعات الباقي.',
